...
void init()
{
  ...
  glUniform4fv(glGetUniformLocation(program, "AmbientProduct"), 1, reinterpret_cast<const float*>(&ambient_product));
  glUniform4fv(glGetUniformLocation(program, "DiffuseProduct"), 1, reinterpret_cast<const float*>(&diffuse_product));
  glUniform4fv(glGetUniformLocation(program, "SpecularProduct"), 1, reinterpret_cast<const float*>(&specular_product));
  glUniform4fv(glGetUniformLocation(program, "LightPosition"), 1, reinterpret_cast<const float*>(&light_position));
